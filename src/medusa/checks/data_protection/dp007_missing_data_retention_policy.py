        ...
        if not snapshot.config_raw:
            findings.append(
                Finding(
                    ...
                    status_extended="No data retention or TTL policy configuration detected.",
                    evidence="missing_keys=retention,ttl,expiry",
        ...
        if not found:
            ...
            findings.append(
                Finding(
                    ...
                    resource_type="server",
                    resource_name=snapshot.server_name,
                    status_extended="Data retention policy configuration detected.",
                    remediation=meta.remediation,
                    owasp_mcp=meta.owasp_mcp,
                )
            )
