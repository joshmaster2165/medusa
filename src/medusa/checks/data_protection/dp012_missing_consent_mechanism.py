        ...
        if not snapshot.config_raw:
            findings.append(
                Finding(
                    ...
                    status_extended="No consent or privacy mechanism configuration detected.",
                    evidence="missing_keys=consent,gdpr,opt_in",
        ...
        if not found:
            ...
            findings.append(
                Finding(
                    ...
                    resource_type="server",
                    resource_name=snapshot.server_name,
                    status_extended="Consent/privacy mechanism configuration detected.",
                    remediation=meta.remediation,
                    owasp_mcp=meta.owasp_mcp,
                )
            )
