"""IV042: XML External Entity Injection (XXE).

Detects tool parameters with XML-related names that lack input validation
constraints. Unvalidated XML parameters allow attackers to inject XXE payloads
like <!DOCTYPE> and <!ENTITY> to read local files, perform SSRF, or cause
...
class XmlInjectionCheck(BaseCheck):
    ...
    async def execute(self, snapshot: ServerSnapshot) -> list[Finding]:
        ...
        for tool in snapshot.tools:
            ...
            for param_name, param_def in properties.items():
                ...
                if lower_name not in _XML_PARAM_NAMES:
                    continue
                ...
                findings.append(
                    Finding(
                        ...
                        status_extended=(
                            ...
                            f"input validation constraints. "
                            f"Attackers can inject XXE payloads "
