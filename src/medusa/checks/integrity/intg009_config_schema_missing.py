        ...
        if not snapshot.config_raw:
            findings.append(
                Finding(
                    ...
                    status_extended="No configuration schema reference found.",
                    evidence="missing_keys=$schema,json_schema,config_schema",
        ...
        if not has_keys:
            ...
            findings.append(
                Finding(
                    ...
                    resource_type="server",
                    resource_name=snapshot.server_name,
                    status_extended="Configuration schema reference detected.",
                    remediation=meta.remediation,
                    owasp_mcp=meta.owasp_mcp,
                )
            )
