        ...
        if not snapshot.config_raw:
            findings.append(
                Finding(
                    ...
                    status_extended="No reproducible/deterministic build configuration detected.",
                    evidence="missing_keys=reproducible,deterministic,hermetic",
        ...
        if not has_keys:
            ...
            findings.append(
                Finding(
                    ...
                    resource_type="server",
                    resource_name=snapshot.server_name,
                    status_extended="Reproducible build configuration detected.",
                    remediation=meta.remediation,
                    owasp_mcp=meta.owasp_mcp,
                )
            )
