        ...
        if not snapshot.config_raw:
            findings.append(
                Finding(
                    ...
                    status_extended="No subresource integrity or checksum configuration detected.",
                    evidence="missing_keys=integrity,sri,checksum",
        ...
        if not has_keys:
            ...
            findings.append(
                Finding(
                    ...
                    resource_type="server",
                    resource_name=snapshot.server_name,
                    status_extended="Subresource integrity configuration detected.",
                    remediation=meta.remediation,
                    owasp_mcp=meta.owasp_mcp,
                )
            )
